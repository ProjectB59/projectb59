...
var EVENTS = [
  {y:1976, cat:'crypto', t:'New Directions in Cryptography', who:'Whitfield Diffie & Martin Hellman',
   d:'Public-key cryptography is born. For the first time two strangers can agree on a secret over an open wire: the mathematical foundation everything here is built on.', rec:'B59-301.001'},
  ...
  {y:1982, cat:'cash', t:'Blind Signatures for Untraceable Payments', who:'David Chaum',
   d:'Chaum shows how a bank can sign a coin without seeing it: unconditional payer anonymity. The intellectual seed of all digital cash.', rec:'B59-201.003'},
  {y:1985, cat:'cash', t:'Security Without Identification', who:'David Chaum',
   d:'"Transaction systems to make Big Brother obsolete." Chaum lays out a whole society of privacy-preserving credentials.', rec:'B59-202.002'},
  {y:1990, cat:'cash', t:'DigiCash / ecash founded', who:'David Chaum',
   d:'Chaumian ecash goes commercial. Brilliant cryptography, but a centralized mint, a single point of failure that history will not forgive.', rec:'B59-001.005'},
  ...
  {y:1991, cat:'cypher', t:'PGP 1.0 released', who:'Phil Zimmermann',
   d:'Strong encryption reaches anyone with a modem, and triggers a three-year federal criminal investigation into its author.', rec:'B59-101.008'},
  {y:1992, cat:'pow', t:'Pricing via Processing, or Combatting Junk Mail', who:'Cynthia Dwork & Moni Naor',
   d:'The origin of proof-of-work. To deter spam, require the sender to compute a moderately hard function first, imposing a real cost on abuse while staying free for honest use. Every later PoW system descends from this idea.', rec:'B59-402.001', star:true},
  {y:1992, cat:'cypher', t:'The Cypherpunks form', who:'Eric Hughes, Tim May & John Gilmore',
   d:'A mailing list and a mantra: "Cypherpunks write code." Privacy will be built, not legislated.', rec:'B59-002.003'},
  {y:1993, cat:'cypher', t:'A Cypherpunk\u2019s Manifesto', who:'Eric Hughes',
   d:'"Privacy is necessary for an open society in the electronic age." The movement\u2019s founding text.', rec:'B59-306.004'},
  {y:1993, cat:'cypher', t:'The Clipper Chip', who:'US Government',
   d:'A proposed key-escrow chip that would give the state a backdoor to all encryption. The backlash galvanizes the crypto wars.', rec:'B59-302.007'},
  {y:1994, cat:'cypher', t:'Anonymous Remailers mature', who:'Hal Finney and others',
   d:'Finney builds and documents mix-based remailers: real privacy infrastructure shipped while the law is still hostile.', rec:'B59-303.004'},
  {y:1995, cat:'crypto', t:'The SSL Challenge', who:'Hal Finney',
   d:'Finney\u2019s challenge to break Netscape\u2019s export-grade 40-bit SSL is solved in days, proving that crypto weakened by law protects no one.', rec:'B59-106.002'},
  ...
  {y:1998, cat:'cash', t:'Secure Property Titles with Owner Authority', who:'Nick Szabo',
   d:'A replicated, Byzantine-fault-tolerant registry of ownership with no central authority: the property-rights half of a decentralized economy.', rec:'B59-503.002'},
  {y:2004, cat:'pow', t:'RPOW: Reusable Proofs of Work', who:'Hal Finney',
   d:'Finney makes hashcash tokens reusable via a transparent, remotely-attestable server. The last conceptual step before Bitcoin.', rec:'B59-504.010'},
  {y:2005, cat:'cash', t:'Bit Gold', who:'Nick Szabo',
   d:'Proof-of-work chained and timestamped into unforgeable, ownable digital scarcity. Bitcoin\u2019s clearest single precursor.', rec:'B59-204.003'},
  {y:2008, cat:'bitcoin', t:'Bitcoin: A Peer-to-Peer Electronic Cash System', who:'Satoshi Nakamoto',
   d:'Every strand ties together: hashes, Merkle trees, timestamping and proof-of-work become one system with no mint and no trusted third party.', rec:'B59-404.001', star:true},
  {y:2009, cat:'bitcoin', t:'Genesis block & the first transaction', who:'Satoshi Nakamoto → Hal Finney',
   d:'January 3: the chain begins. Nine days later Satoshi sends 10 bitcoin to Hal Finney, the first transaction, and the moment this whole history becomes running code.', rec:'B59-001.010'}
];
